    ...
    <View style={leaderBoardLeaderShipStyles.container} >
        <View style={[leaderBoardLeaderShipStyles.leaderBoardCardStyle,{flex:2}]} >
            ...
            style={{
                ...
                source={{uri:imageUrl}}
            />
            <Text style={leaderBoardLeaderShipStyles.leaderBoardCardTextStyle} >{userName}</Text>
        </View>
        <View style={leaderBoardLeaderShipStyles.leaderBoardCardStyle} >
            <Text style={leaderBoardLeaderShipStyles.leaderBoardCardTextStyle} >{userPoints}</Text>
            <Image 
            style={{
                height:30,
                width:30,
