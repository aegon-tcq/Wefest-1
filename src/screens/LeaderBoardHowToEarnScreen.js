...
const HowToEarnText = ({simpleText="Headline", highlightedText="(10 Points)"}) => (
    <View>
        <Text style={{color:"#464d55",fontSize:18,textAlign:"center"}} >{simpleText}</Text>
    <Text style={{color:"#464d55",fontSize:18,fontWeight:"bold",textAlign:"center"}} >{highlightedText}</Text>
    </View>
)
